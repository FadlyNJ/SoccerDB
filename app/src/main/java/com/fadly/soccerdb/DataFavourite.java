...
public class DataFavourite extends RecyclerView.Adapter<com.fadly.soccerdb.DataFavourite.DatakuViewHolder> {
    ...
    public DataFavourite(List<ModelRealm> dataList, Callback callback) {
    ...
    public void onBindViewHolder(final DatakuViewHolder holder, final int position) {
        holder.txtName.setText(dataList.get(position).getTeam_name());
        holder.txtLeague.setText(dataList.get(position).getLeague());
        holder.txtStadium.setText(dataList.get(position).getStadium());
    ...
    public class DatakuViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        private TextView txtName, txtLeague, txtStadium;
        CardView card;
        ImageView ivprofile;
        ...
        public DatakuViewHolder(View itemView) {
            ...
            txtLeague = (TextView) itemView.findViewById(R.id.tvleague);
