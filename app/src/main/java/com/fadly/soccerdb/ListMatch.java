...
public class ListMatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(com.fadly.soccerdb.ListMatch.this);
                        ...
                        try {
                            ...
                            adapter = new AdapterMatch(DataArrayList, new AdapterMatch.Callback() {
                                ...
                                public void onClick(int position) {
                                    ...
                                    Toast.makeText(com.fadly.soccerdb.ListMatch.this, ""+position, Toast.LENGTH_SHORT).show();
                                }
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.fadly.soccerdb.ListMatch.this);
