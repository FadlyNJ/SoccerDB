...
public class ListData extends AppCompatActivity {
    ...
    com.fadly.soccerdb.DataAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(com.fadly.soccerdb.ListData.this);
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            //Handle Click
                            adapter = new com.fadly.soccerdb.DataAdapter(DataArrayList, new com.fadly.soccerdb.DataAdapter.Callback() {
                                @Override
                                public void onClick(int position) {
                                    Model team = DataArrayList.get(position);
                                    Intent intent = new Intent(getApplicationContext(), com.fadly.soccerdb.DetailTeam.class);
                                    ...
                                    Toast.makeText(com.fadly.soccerdb.ListData.this, ""+position, Toast.LENGTH_SHORT).show();
                                }
                            ...
                            RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(com.fadly.soccerdb.ListData.this);
